...
// Metric описывает единичную метрику.
type Metric struct {
...
const file_metrics_proto_rawDesc = "" +
	"\n" +
	"\rmetrics.proto\x12\ametrics\x1a!google/protobuf/go_features.proto\"\x90\x01\n" +
	"\x06Metric\x12\x0e\n" +
	...
	"\aMetrics\x12N\n" +
	"\rUpdateMetrics\x12\x1d.metrics.UpdateMetricsRequest\x1a\x1e.metrics.UpdateMetricsResponseB=Z1github.com/iliaonishchenko/aggreg8/internal/proto\x92\x03\a\xd2>\x02\x10\x03\b\x02b\beditionsp\xe8\a"
